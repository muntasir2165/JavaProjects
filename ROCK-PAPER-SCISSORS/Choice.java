...
public class Choice
{
    ...
    public int compareWith(Choice anotherChoice)
    {
        ...
        int otherType = anotherChoice.getType();
        int result = 0;
        
        if (thisType == otherType) {
            result = 0;
        }
        else if (thisType == 0 && otherType == 1) {
            result = -1;
        }
        else if (thisType == 0 && otherType == 2) {
            result = 1;
        }
        else if (thisType == 1 && otherType == 0) {
            result = 1;
        }
        else if (thisType == 1 && otherType == 2) {
            result = -1;
        }
        else if (thisType == 2 && otherType == 0) {
            result = -1;
        }
        else if (thisType == 2 && otherType == 1) {
            result = 1;
        }
        return result;
    }
